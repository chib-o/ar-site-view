...
_worker_js__WEBPACK_IMPORTED_MODULE_5__.default.prototype.toContainer = function toContainer() {
  return orig.toContainer.call(this).then(function toContainer_pagebreak() {
    ...
    // pts version
    // var pxPageHeight = this.prop.pageSize.inner.px.height * 0.75;
    ...
    Array.prototype.forEach.call(els, function pagebreak_loop(el) {
      ...
      if (rules.before) {
        var pad = (0,_utils_js__WEBPACK_IMPORTED_MODULE_6__.createElement)('div', {
          style: {
            display: 'block',
            height: pxPageHeight - clientRect.top % pxPageHeight - 10 + 'px'
          }
        });
      ...
      if (rules.after) {
        var pad = (0,_utils_js__WEBPACK_IMPORTED_MODULE_6__.createElement)('div', {
          style: {
            display: 'block',
            height: pxPageHeight - clientRect.bottom % pxPageHeight - 10 + 'px'
          }
        });
